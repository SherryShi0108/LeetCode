 ...
 *          is '-' or '+'. Read this character in if it is either. This determines if the final result
 ...
 *          integers less than -231 should be clamped to -231, and integers greater than 2^31 - 1 should be clamped to 2^31 - 1.
